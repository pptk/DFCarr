...
@class DFAttributedLabelURL;

@interface DFAttributedLabel : UIView
@property (nonatomic,weak)    id<DFAttributedLabelDelegate> delegate;
...
//设置全局的自定义Link检测Block(详见DFAttributedLabelURL)
